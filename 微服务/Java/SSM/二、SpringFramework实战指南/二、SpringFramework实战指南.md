...
7.  图解IoC配置流程
    ...
    <img src="image/image_1TRaZzVWj_.png" style="zoom:150%;" />
...
2.  组件作用域配置
    1.  Bean作用域概念
        ...
        这意味着，`BeanDefinition`与`类`概念一样，SpringIoC容器可以根据`BeanDefinition`对象反射创建多个Bean对象实例。
...
5.  **扩展JSR-250注解@Resource**
    ...
    -   JSR-250 @Resource注解
        ...
        -   @Resource注解是**JDK扩展包中的，也就是说属于JDK的一部分**。所以该注解是标准注解，更加具有通用性。(JSR-250标准中制定的注解类型。JSR是Java规范提案。)
...
```
ProceedingJoinPoint  与  JoinPoint 区别是 ProceedingJoinPoint可以执行目标方法，而JoinPoint只能获取目标方法信息
```
...
### 6.3 Spring5——Spring事务原理

https://www.jianshu.com/p/68526b604648

### 6.4事务原理源码分析

https://www.jianshu.com/p/02d4a00b23d7

### 6.5 TransactionSynchronizationManager用法和含义

https://www.jianshu.com/p/fa3cd0e9a13a

### 6.6 Spring 事务扩展机制 TransactionSynchronization

https://www.jianshu.com/p/16e90b39477b

### 6.7 Spring事务事件控制，解决业务异步操作

https://www.jianshu.com/p/085ab9007456

### 6.8 SpringBoot 事务失效及其对应解决办法

https://blog.csdn.net/zhouzhiwengang/article/details/136359656?spm=1001.2101.3001.6650.2&utm_medium=distribute.pc_relevant.none-task-blog-2%7Edefault%7EYuanLiJiHua%7EPosition-2-136359656-blog-130244562.235%5Ev43%5Epc_blog_bottom_relevance_base4&depth_1-utm_source=distribute.pc_relevant.none-task-blog-2%7Edefault%7EYuanLiJiHua%7EPosition-2-136359656-blog-130244562.235%5Ev43%5Epc_blog_bottom_relevance_base4&utm_relevant_index=5

### 6.9 多线程事务

https://www.jb51.net/article/258625.htm
